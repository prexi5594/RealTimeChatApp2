      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="max-w-2xl w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              to="/chat"
              className="px-10 py-4 bg-white text-blue-600 font-bold rounded-lg hover:bg-blue-50 transition transform hover:scale-105 text-lg"
            >
              Start Chatting
            </Link>
            <Link
              to="/login"
              className="px-10 py-4 bg-blue-800 text-white font-bold rounded-lg hover:bg-blue-900 transition transform hover:scale-105 text-lg border-2 border-white"
            >
              Login
            </Link>
          </div>
